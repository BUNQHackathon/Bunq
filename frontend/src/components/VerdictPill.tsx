...
const CONFIG: Record<Verdict, { hex: string; bg: string; border: string; emoji: string; label: string }> = {
  GREEN:   { hex: '#cfb275', bg: 'rgba(207,178,117,0.12)', border: '1px solid rgba(207,178,117,0.3)', emoji: '🟢', label: 'GREEN'   },
  AMBER:   { hex: '#b87538', bg: 'rgba(184,117,56,0.12)',  border: '1px solid rgba(184,117,56,0.3)',  emoji: '🟡', label: 'AMBER'   },
  RED:     { hex: '#a83820', bg: 'rgba(168,56,32,0.12)',   border: '1px solid rgba(168,56,32,0.3)',   emoji: '🔴', label: 'RED'     },
