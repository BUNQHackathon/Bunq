...
public final class ToolDefinitions {
    ...
    public static final String SCORE_RELEVANCE_TOOL = loadResource("/prompts/tools/score_relevance.json");
    ...
    public static final String MATCH_OBLIGATIONS_BATCH_TOOL = loadResource("/prompts/tools/match_obligations_batch.json");
